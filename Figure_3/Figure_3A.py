...
pickle.dump(txx,open('txx.pkl','wb'))
#######################################MSM loading##############################################
...
y_key = 'Helix2M_Nloop'                             #feature used here to plot in y-direction

x_data =  txx[:,dica[x_key]]*10                     #assign x_data as 1-D array with x-direction feature (change nm to angtrom)
y_data =  txx[:,dica[y_key]]*10                     #assign y_data as 1-D array with y-direction feature (change nm to angtrom)
...
axs.set_ylim([14,26])                                                                           #min and max limit of y-axis

axs.set_xticks(range(int(9),int(33)+1,4))                                                       #x-axis ticks
axs.set_yticks(range(int(14),int(26)+1,4))                                                      #y-axis ticks
...
axs.set_yticklabels(range(int(14),int(26)+1,4))                                                 #y-axis ticklabels

plt.xlabel('THC Binding' + ' (\AA)', **hfont,fontsize=30)                                       #x-axis label
plt.ylabel('N-loop Movement' + ' (\AA)', **hfont,fontsize=30)                                   #y-axis label
